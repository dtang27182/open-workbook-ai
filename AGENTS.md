...
- Within each `Interface Points` list, group related changes by purpose and introduce each group with a concise narrative sentence explaining how the changes fit together. Order the groups so the reader can follow the overall flow of the change.
