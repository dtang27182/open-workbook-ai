...
The state may provide common operations used by multiple workflows, including potential-restore-point creation, LLM-history appends, and numbered diff-sheet creation. Keep these operations close to the shared state they mutate and continue using the existing transcript and restore-point helper modules.
